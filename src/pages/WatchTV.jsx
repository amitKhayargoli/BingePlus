...
const WatchTV = () => {
  ...
  useEffect(() => {
    if (episodes.length > 0 && (!selectedEpisode || !episodes.find(e => e.id === selectedEpisode.id))) {
  ...
  <div className="flex-grow bg-black flex items-center justify-center">
    {selectedEpisode && (
      <div className="w-full h-full">
        <iframe
          src={`https://vidlink.pro/tv/${id}/${selectedSeason}/${selectedEpisode.episode_number}`}
          allowFullScreen
  ...
  {/* Right: Episodes List */}
  <div className="w-full max-w-md bg-black flex flex-col h-full overflow-y-auto p-8">
